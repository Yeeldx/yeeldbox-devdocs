...
Used to track the deployed version of this contract. In practice you can use this version number to compare with Yeeldx&#39;s GitHub and determine which version of the source matches this deployed contract.    
