...
Almost everything that yVaults interact with is available to the public. So how is Yeeldx able to offer users better yield than they'd be able to achieve on their own?
...
Using the Backscratcher yVault, Yeeldx locks up a significant amount of CRV indefinitely, and distributes the boosts to various yVaults.

### Backscratcher yVaults

The Backscratcher yVault, yvBOOST and pSLPyvBOOST-ETH, capitalizes on liquidity mining in a way that's beneficial to both Curve and Yeeldx.
...
In return, control over the locked CRV's boosts is given to Yeeldx, and utilized throughout various yVaults.
...
Yeeldx utilizes the [Iron Bank (C.R.E.A.M. Finance)](https://docs.ib.xyz/) to access credit that is used to enhance yVault yields. Only white-listed addresses have this feature available to them, meaning that typically, individuals are not able to do this on their own.
