...
1. Wrapper deposits into Yeeldx Vault
...
- Vault tokens are not fungible with other partner tokens or with Yeeldx's vanilla vault tokens
...
1. Routing contract routes the deposit into the Yeeldx Vault
...
- User gets credited regular vanilla Yeeldx vault tokens for a better user experience
